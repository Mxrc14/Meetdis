...
class OfertaFiltrarRecyclerAdapter : RecyclerView.Adapter<OfertaFiltrarRecyclerAdapter.ViewHolder>() {
    private val db = FirebaseFirestore.getInstance()
    var ofertes: ArrayList<Oferta> = ArrayList()
    lateinit var context: Context


    fun OfertaFiltrarRecyclerAdapter(ofertasList: ArrayList<Oferta>, contxt: Context) {
    ...
    ofertes[position]
        ...
        holder.itemView.setOnClickListener {
            ...
            holder.itemView.findNavController().navigate(
                R.id.action_filtratFragment_to_ofertaFragment, bundle
            )
